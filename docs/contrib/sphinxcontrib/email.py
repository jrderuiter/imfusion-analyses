...
# This code was modified from sphinxcontrib-email for Python 3 compatability.
#
# The original obfuscation code was taken from
#
...
def js_obfuscated_mailto(email, displayname=None):
    ...
    if not displayname:
        displayname = email
    return js_obfuscated_text("""<a href="mailto:%s">%s</a>""" % (email,
                                                                  displayname))
